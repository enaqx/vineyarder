...
var ImageSourceMixin = {
   ...
   *
   * NOTE: During SSR, we have no way of knowing what the target
   * devicePixelRatio will be so we err on the side of the larger image.
   * If this is wrong, React will correct the DOM but complain that the
